...
# Параметры
BUNDLE_ID="com.xtremeamazng.cube"
APPLE_ID="6757011447"
REMOTE_URL="git@github.com:sdeslvm/Cube-Xtreme-Amazing.git"
PROJECT_NAME="Cube Xtreme Amazing"
SCHEME_NAME="Cube Xtreme Amazing"
