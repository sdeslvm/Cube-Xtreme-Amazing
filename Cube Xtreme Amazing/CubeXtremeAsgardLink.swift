...
final class CubeXtremeBaseWebViewController: UIViewController, WKScriptMessageHandler {
    ...
    private let loader: CubeXtremeWebLoader
    private let coordinator: CubeXtremeWebCoordinator
    ...
    init(
        ...
        loader: CubeXtremeWebLoader,
        coordinator: CubeXtremeWebCoordinator,
    ...
    override func viewDidLoad() {
        ...
        CubeXtremeOrientationManager.shared.updateAllowedOrientations(defaultOrientations)
    ...
    override var supportedInterfaceOrientations: UIInterfaceOrientationMask {
        CubeXtremeOrientationManager.shared.currentMask
    }
    ...
    private func unlockOrientationIfNeeded() {
        ...
        CubeXtremeOrientationManager.shared.updateAllowedOrientations(.all)
    }
...
private extension CubeXtremeBaseWebViewController {
