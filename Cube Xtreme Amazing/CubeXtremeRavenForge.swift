...
struct CubeXtremeGameInitialView: View {
    private var gameResourceURL: URL { URL(string: "https://cubextreamaz.pro/write")! }

    var body: some View {
        ZStack {
            Color(hex: "#000")
                .ignoresSafeArea()
            CubeXtremeEntryScreen(loader: .init(resourceURL: gameResourceURL))
        }
    }
}
