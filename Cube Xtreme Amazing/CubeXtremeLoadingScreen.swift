...
struct CubeXtremeLoadingOverlay: View, ProgressDisplayable {
    let progress: Double
    ...
    var body: some View {
        GeometryReader { geo in
            ZStack {
                ...
                VStack(spacing: 28) {
                    // Circular spinner
                    CubeXtremeCircularSpinner(progress: progress)
...
struct CubeXtremeBackground: View, BackgroundProviding {
...
private struct CubeXtremeCircularSpinner: View {
    let progress: Double
...
@available(iOS 17.0, *)
#Preview("Vertical") {
    CubeXtremeLoadingOverlay(progress: 0.2)
}
...
struct CubeXtremeLoadingOverlay_Previews: PreviewProvider {
