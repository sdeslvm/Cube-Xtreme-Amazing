...
class CubeXtremeWebCoordinator: NSObject, WKNavigationDelegate, WKUIDelegate {
    private let callback: (CubeXtremeWebStatus) -> Void
    private var didStart = false

    init(onStatus: @escaping (CubeXtremeWebStatus) -> Void) {
