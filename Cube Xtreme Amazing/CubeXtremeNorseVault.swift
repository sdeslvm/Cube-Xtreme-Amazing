...
final class CubeXtremeOrientationManager {
    static let shared = CubeXtremeOrientationManager()
...
final class CubeXtremeAppDelegate: NSObject, UIApplicationDelegate {
    func application(
