...
enum CubeXtremeWebStatus: Equatable, WebStatusComparable {
    case standby
    ...
    func isEquivalent(to other: CubeXtremeWebStatus) -> Bool {
        switch (self, other) {
...
extension CubeXtremeWebStatus {
    static func == (lhs: CubeXtremeWebStatus, rhs: CubeXtremeWebStatus) -> Bool {
